...
<div id="container" class="mainContext">
    ...
    <div id="content_right">
        <c:choose>
            ...
            <c:otherwise>
                <img class="" src="picture/Valuerank.png" />
                <c:forEach items="${sessionScope.comp3}" var="current_comp" varStatus="status">
                    ...
                    <div class="stock-info">
                        <div class="stock-bets">
                            <h1>
                                <a class="bets-name" href="">${current_comp.rank_index}. ${current_comp.symbol}</a>
                                <a class="stock-chart"><canvas width="150" height="30" id="${current_comp.symbol}"></canvas></a>
                                <script>PaintLine('${current_comp.symbol}', ${sessionScope.pricelist3.get(status.index)});</script>
                            </h1>
                            <div class="price s-stop ">
